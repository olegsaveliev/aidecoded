...
const CAM_TOOLS = {
  0: [
    { name: 'OpenAI API', color: '#34C759', desc: 'GPT-5, GPT-5.2, GPT-4.1 model family' },
    { name: 'Claude', color: '#34C759', desc: 'Claude Opus, Sonnet, Haiku model family' },
    { name: 'Gemini', color: '#34C759', desc: 'Gemini 3 Pro, Gemini Flash models' },
    { name: 'Grok', color: '#34C759', desc: 'Grok 4.1 with real-time X integration' },
    { name: 'Llama', color: '#34C759', desc: 'Llama 4 open-source model family' },
    { name: 'DeepSeek API', color: '#34C759', desc: 'Cost-efficient frontier-class models' },
    { name: 'Mistral', color: '#34C759', desc: 'European open-source AI models' },
    { name: 'Qwen', color: '#34C759', desc: 'Qwen3 open-source model family' },
...
function ChoosingAIModel({ onSwitchTab, onGoHome }) {
  ...
  useEffect(() => {
    const cancel = scrollStageToTop('.cam-root', activeStepRef)
    return cancel
  }, [stage])
