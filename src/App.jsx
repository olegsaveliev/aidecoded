  ...
  return (
    <div className={`app ${!showSidebar ? 'app-no-sidebar' : ''} app-fade-in`}>
      ...
      <main className="main">
              ...
              <div className="header-avatar-wrap" onClick={(e) => e.stopPropagation()}>
                ...
                {showAvatarDropdown && (
                  <div className="avatar-dropdown">
                    ...
                    <button className="avatar-dropdown-item avatar-dropdown-item-signout" onClick={() => { signOut(); setShowAvatarDropdown(false); setActiveTab('playground'); setShowLanding(true); setShowHome(false); sessionStorage.removeItem('auth_return_tab'); setPendingAuthReturn(null); window.history.replaceState(null, '', window.location.pathname) }}>
        ...
        {!showHome && canRenderModule && activeTab === 'ollama' && (
          <Ollama onSwitchTab={handleSwitchTab} onGoHome={handleGoHome} />
        )}
        ...
        {!showHome && canRenderModule && activeTab === 'custom-agents' && (
          <CustomAgents onSwitchTab={handleSwitchTab} onGoHome={handleGoHome} />
        )}
        {!showHome && canRenderModule && activeTab === 'model-training-tycoon' && (
          <ModelTrainingTycoon onSwitchTab={handleSwitchTab} onGoHome={handleGoHome} />
        )}
        ...
        {!showHome && canRenderModule && activeTab === 'ai-pm-workflows' && (
          <AIPMWorkflows onSwitchTab={handleSwitchTab} onGoHome={handleGoHome} />
        )}
